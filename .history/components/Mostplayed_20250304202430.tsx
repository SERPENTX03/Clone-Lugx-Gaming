...
const Mostplayed = () => {
  return (
    <section className="mt-36 bg-gray-100 rounded-full py-24">
      <div className=" sm:px-16">
        <div className="pb-10 text-center lg:text-left">
          <h5 className="uppercase text-red-500 mb-6 font-bold">TOP GAMES</h5>
          <div className="flex justify-between  ">
            <h1 className=" text-center lg:text-left capitalize font-extrabold text-3xl lg:text-4xl">
              Most Played
            </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
          {mostPlayed.map((played, index) => (
            <div key={index} className="w-full border rounded-xl shadow-xl">
