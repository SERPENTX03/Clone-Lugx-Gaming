      ...
      <div className=" sm:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 ">
          {mostPlayed.map((played, index) => (
            <div
              key={index}
              className="w-full relative text-center border overflow-hidden shadow-xl rounded-3xl"
            >
              <p className="absolute -bottom-2 left-1/2 transform z-50 -translate-x-1/2 w-fit bg-red-500">
                {played.explore}
              </p>
