const Subscribe = () => {
  return (
    <section className="sm:px-20 relative mt-32 w-full -z-20 flex">
      <div className="cat-bg hidden lg:block relative top-0 left-1/2 transform -translate-x-1/2"></div>

      <div>
        <div className="relative lg:w-[300px] lg:top-1/3 lg:transform lg:-translate-y-1/2">
        ...
        <div className="relative lg:w-[300px] lg:bottom-1/2 -right-[600px] lg:transform lg:-translate-y-1/2">
