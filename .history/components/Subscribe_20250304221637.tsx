const Subscribe = () => {
  return (
    <section className="relative mt-32 w-full px-4 sm:px-20">
      ...
      <div className="relative flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8">
        {/* Our Shop Block - Left, moved down 20% */}
        ...
        {/* Newsletter Block - Right, moved down 60% */}
        <div className="relative lg:w-[500px] lg:mt-[60%]">
