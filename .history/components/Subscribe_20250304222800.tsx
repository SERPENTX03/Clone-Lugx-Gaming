const Subscribe = () => {
  return (
    <section className="relative mt-32 w-full px-4 sm:px-20">
      ...
      <div className="relative flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 lg:gap-x-60">
        ...
        <div className="relative lg:w-[500px] lg:mt-[20%]">
          <div className="bg-gray-100 p-8 rounded-xl">
            ...
            <div className="lg:flex flex-row items-center border">
              <input
                className="mt-10 w-fit flex lg:items-center justify-center py-3 px-5 rounded-full border border-gray-300"
                placeholder="your email..."
                type="text"
              />
              <button className="mt-3 w-fit h-fit py-3  px-5 rounded-full bg-red-500 text-white">
                SUBSCRIBE
              </button>
            </div>
          </div>
