        ...
        <div className="relative lg:w-[500px] lg:mt-[20%]">
          <div className="bg-gray-100 p-8 rounded-xl">
            ...
            <div className="lg:relative mt-10">
              <input
                className="rounded-full px-10 w-full h-12 border mb-4 lg:mb-0 border-gray-300"
                placeholder="your email..."
                type="text"
              />
              <button
                className="uppercase text-white h-12 w-full lg:w-fit lg:absolute right-0
             rounded-full px-6 bg-red-500 hover:bg-blue-500  duration-500 ease-in-out"
              >
                {" "}
                SUBSCRIBE
              </button>
