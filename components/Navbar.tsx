...
const Navbar = () => {
  ...
  return (
    <nav className={`z-50 sticky top-0 transition-all duration-500 ${
      isScrolled ? "bg-blue-600 rounded-b-3xl" : "bg-transparent"
    }`}>
  <div className="py-6 flex justify-between items-center px-10 md:px-[4.5rem]">
    <Image className="w-fit h-10 lg:h-16 object-contain" src={logo} alt="Logo" />
